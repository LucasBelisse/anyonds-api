    ...
    try:
        ...
        for col in df.columns:
            ...
            if np.issubdtype(df[col].dtype, np.number):
                ...
                # Se for coluna de letras/textos (object), define as estatísticas como nulas de forma segura
                stats["mean"] = None
                stats["min"] = None
                stats["max"] = None
        ...
        # Obter prévia das primeiras 15 linhas limpas de NaNs
...
async def train(
    ...
    try:
        ...
        if problem_type == "regression":
            ...
            raise ValueError(f"Tipo de problem_type '{problem_type}' não reconhecido.")
